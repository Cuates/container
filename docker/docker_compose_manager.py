...
def make_raw(path):
    """
    Convert a file path to a raw string.

    :param path: File path to convert
    :return: Raw string version of the file path
    """
    return fr"{path}"
...
def main():
    ...
    docker_configs = [
        DockerComposeManager(make_raw("<path/to/docker/directory/01>"), "<docker_compose_filename_01.yml>", "<docker_compose_environment_filename_01.env>"),
        DockerComposeManager(make_raw("<path/to/docker/directory/02>"), "<docker_compose_filename_02.yml>", "<docker_compose_environment_filename_02.env>"),
        DockerComposeManager(make_raw("<path/to/docker/directory/03>"), "<docker_compose_filename_03.yml>", "<docker_compose_environment_filename_03.env>")
    ]
